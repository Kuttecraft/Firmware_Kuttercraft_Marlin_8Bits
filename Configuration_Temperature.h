...
#define HEATER_0_MINTEMP 0 // (degC)
#define HEATER_1_MINTEMP 0 // (degC)
#define HEATER_2_MINTEMP 0 // (degC)
#define HEATER_3_MINTEMP 0 // (degC)
#define BED_MINTEMP      0 // (degC)
#define CHAMBER_MINTEMP  0 // (degC)
...
#define PID_FUNCTIONAL_RANGE 5         // degC
...
#define DEFAULT_Kp {17.57, 17.57, 17.57, 17.57}     // Kp for H0, H1, H2, H3
#define DEFAULT_Ki {0.71, 0.71, 0.71, 0.71}     // Ki for H0, H1, H2, H3
#define DEFAULT_Kd {108, 108, 108, 108}     // Kd for H0, H1, H2, H3
...
#define EXTRUDE_MINTEMP 0                 // Degree Celsius
