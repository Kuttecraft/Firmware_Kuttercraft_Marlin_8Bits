...
/* Maker Kuttercraft 3D Printer Firmware
/**
 * -----------------
 * Implemented Codes
 * -----------------
 ...
 * G5  - Bezier curve - fromA
 * G7  - Laser raster base64
 *
 * G10 - retract filament according t o settings of M207 
 ...
 * M48  - Measure   repeatability. M48 [P # of points] [X position] [Y position] [V_erboseness #] [E_ngage Probe] [L # of legs of travel]
