...
#elif(PK3_EXTEN)
	#define MSG_TIPO                      "PK3+E"

#elif(PK3)
	#define MSG_TIPO                      "PK3"

#elif(MK_TITAN)
	#define MSG_TIPO                      "TITAN"
...
/*++++++++++++++++++++++++++++++++++++++++++++++*/
#if(PK3_EXTEN)
	#define MSG_MODELO      "PK3++ EXTENDIDA\n"

#elif(PK3_PLUS_PLUS)
	#define MSG_MODELO      "PK3++\n"

#elif(PK3)
	#define MSG_MODELO      "PK3\n"

#elif(MK_TITAN)
	#define MSG_MODELO      "TITAN\n"

#elif(PK2_PLUS_PLUS)
	#define MSG_MODELO      "PK2++\n"

#elif(PK2)
	#define MSG_MODELO      "PK2\n"

#elif(PK1)
	#define MSG_MODELO      "PK1\n"
...
/*++++++++++++++++++++++++++++++++++++++++++++++*/
#if(LCD)
	#define MSG_PANTALLA      "LCD_(RepRap)\n"

#elif(TACTIL)
	#define MSG_PANTALLA      "Tactil_(Kuttercraft)\n"

#elif(OLED)
	#define MSG_PANTALLA      "Oled_(Kuttercraft)\n"
#endif
...
#define FILAMENT_CHANGE_X_POS 5             // X position of hotend
#define FILAMENT_CHANGE_Y_POS 5             // Y position of hotend
#define FILAMENT_CHANGE_Z_ADD 5            // Z addition of hotend (lift)
...
#define FILAMENT_CHANGE_RETRACT_FEEDRATE 10 // Initial retract feedrate in mm/s
#define FILAMENT_CHANGE_UNLOAD_LENGTH 20   // Unload filament length from hotend in mm
 ...
 **************************************************************************/
#if(MK_TITAN)
	#define MESH_MIN_X (X_MIN_POS) //0
	#define MESH_MAX_X (X_MAX_POS - 45) //300

	#define MESH_MIN_Y (Y_MIN_POS) //0 + 65
	#define MESH_MAX_Y (Y_MAX_POS - 30) //230
#else
	#define MESH_MIN_X (X_MIN_POS)
	#define MESH_MAX_X (X_MAX_POS - MESH_INSET)
	#define MESH_MIN_Y (Y_MIN_POS + 60)
...
#define CFG_SD_FILE           "INFO.info"  // name of the configuration file
/*****************************************************************************************/
...
#define ENCODER_10X_STEPS_PER_SEC   35  // If the encoder steps per sec exceeds this value, multiply steps moved x10 to quickly advance the value
#define ENCODER_100X_STEPS_PER_SEC 60  // If the encoder steps per sec exceeds this value, multiply steps moved x100 to really quickly advance the value
//#define ULTIPANEL_FEEDMULTIPLY          // Comment to disable setting feedrate multiplier via encoder

//#define _LCD                              // general LCD support, also 16x2
...
//Segunda grafica de Kuttercraft
...
// Pantalla Oled Kuttercraft
// ==> RECORDAR INSTALAR  U8glib EN LA LIBRERIA:  http://code.google.com/p/u8glib/wiki/u8glib
// Para activar eliminar el comentario de MKS_OLED13_128x64_FULL_GRAPHICS_CONTROLLER
//
#if(OLED)
...
// Pantalla tactil Kuttercraft

#if(TACTIL)
	#define NEXTION
	#define NEXTION_PORT 2
	#define PRUEBA
#endif
