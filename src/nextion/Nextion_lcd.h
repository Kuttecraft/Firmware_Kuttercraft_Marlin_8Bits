 ...
 */
  ...
  #define NEXTIONLCD_H
    ...
    #define NEXTION_FIRMWARE_FILE   "Kutt Firm 3.0.0.tft"
    #define BUILD_VERSION_TOUCH     "V 1.7.0"
    //                              "Kutterccraft Firm 3.0.0.tft

    extern bool ver_cordenadas;
    extern bool PausaRetirar;
    extern bool PausaCargar;
    extern bool SalirPausaC;

    void finalizoImpresion();
    ...
    //#endif
    //FORCE_INLINE bool hola_hola(void) { return true; }
