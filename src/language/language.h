...
#define MSG_ERR_KILLED                       "Muerte de impresora. kill() called!"
#define MSG_ERR_STOPPED                      "Printer stopped due to errors. Fix the error and use M999 to restart. (Temperature is reset. Set it after restarting)"
#define MSG_BUSY_PROCESSING                  "procesando"
#define MSG_BUSY_PAUSED_FOR_USER             "pausa para uso"
#define MSG_BUSY_PAUSED_FOR_INPUT            "pausa para espera"
#define MSG_UNKNOWN_COMMAND                  "Comando no encontrado: \""
