...
#define ANY_THERMISTOR_IS(n) (THERMISTORHEATER_0 == n) || (THERMISTORHEATER_1 == n) || (THERMISTORHEATER_2 == n) || (THERMISTORHEATER_3 == n) || (THERMISTORBED == n) || (THERMISTORCHAMBER == n) || (THERMISTORCOOLER == n)
  ...
  const short temptable_2[][2] PROGMEM = {
      ...
      */
      ...
      {379 * OVERSAMPLENR, 140},//130

      {411 * OVERSAMPLENR, 135},//125 ||

      {445 * OVERSAMPLENR, 130},//120 ||

      {480 * OVERSAMPLENR, 125},//115 || 480

      {516 * OVERSAMPLENR, 120},//110 || 516

      {553 * OVERSAMPLENR, 115},//105 || 553

      {591 * OVERSAMPLENR, 110},//100 || 591

      {628 * OVERSAMPLENR, 105},//95  || 628

      {665 * OVERSAMPLENR, 100},//90  || 665
      //
      {683 * OVERSAMPLENR, 95},// (Dri)

      {701 * OVERSAMPLENR, 90},// (Dir)

      {719 * OVERSAMPLENR, 85},// (Dir) 85 ||  702

      {737 * OVERSAMPLENR, 80},// 80 || 737
      //
      {770 * OVERSAMPLENR, 75},
      {801 * OVERSAMPLENR, 70},
      {830 * OVERSAMPLENR, 65},
