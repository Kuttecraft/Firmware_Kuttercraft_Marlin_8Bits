...
//mod kuttercraft
  ...
  //extern float offset_mesh;
  extern float offset_mesh_valor;
  //extern uint8_t aux_de_tiempo;
#endif
...
extern void home_eje_selector();
#if (KUTTERCRAFT_MULTIFILAMENT)
  extern bool m750;
  extern bool final_de_carrera_e;
#endif
#if MECH(DELTA)
...
extern bool en_pausa;
extern bool apagar_error_temp;
extern bool estatus_guardado;
extern bool se_permiten_carteles;
...
extern unsigned long actual_capas;
extern unsigned long total_capas;
extern unsigned long capas_de_cambio;
extern bool cambiar_fila_on_off;
extern bool on_off_sensor_de_filamento;

extern bool salida_de_emg_temp_hotend;
extern bool salida_de_emg_temp_bed;
extern int contador_comandos_save;
//extern int save_con;
extern bool save_on_off;
#if HAS(BED_PROBE) && NOMECH(DELTA)
  extern bool g77_finalizo;
  extern float g77_valor_del_z;
  extern float g77_offset;
#endif
#if ENABLED(BARICUDA)
